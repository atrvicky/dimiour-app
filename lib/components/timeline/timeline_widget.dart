...
import 'package:app/models/menu_data.dart';
...
class TimelineWidget extends StatefulWidget {
  ...
  const TimelineWidget(this.timeline, {Key? key}) : super(key: key);
...
class _TimelineWidgetState extends State<TimelineWidget> {
  static const String DefaultEraName = "This Week";
  ...
  double _scaleStartYearStart = -1.0;
  double _scaleStartYearEnd = 1.0;
  ...
  void didUpdateWidget(covariant TimelineWidget oldWidget) {
    ...
    if (timeline != oldWidget.timeline && timeline != null) {
      ...
      setState(() {
        _eraName = timeline.currentEra?.label ?? DefaultEraName;
        _showFavorites = timeline.showFavorites;
      });
    }
  }
